...
function strToMilliseconds(strTime) {
  var _strTime$toString$mat = strTime.toString().match(/([0-9]{2})\:([0-9]{2})\:([0-9]{2})/);

  var _strTime$toString$mat2 = _slicedToArray(_strTime$toString$mat, 4);

  var _ = _strTime$toString$mat2[0];
  var h = _strTime$toString$mat2[1];
  var m = _strTime$toString$mat2[2];
  var s = _strTime$toString$mat2[3];
